...
router.post('/', async (req, res) => {
    const { product_id, sds_url, force = false, use_direct_parser = true, } = req.body;
    ...
    try {
        ...
        logger.info({ parsedData, product_id }, `Storing enhanced SDS metadata for product ${product_id}`);
 ...
 */
function transformToChemfetchFormat(directParserResult, productId, productName) {
